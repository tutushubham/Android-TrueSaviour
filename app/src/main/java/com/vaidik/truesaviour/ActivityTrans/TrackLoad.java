...
import com.vaidik.truesaviour.activites.TrackAct;


public class TrackLoad extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (FirebaseAuth.getInstance().getCurrentUser() == null) {
            return inflater.inflate(R.layout.fragment_track_load, container, false);
        }

        return inflater.inflate(R.layout.fragment_track_loaded, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            view.findViewById(R.id.showTrack).setOnClickListener(view1 -> {
                Intent intent = new Intent(getActivity(), TrackAct.class);
                startActivity(intent);
            });
